...
export default function Vehicles({ vehicles }) {
  ...
  return (
    <Layout>
      <div className="grid grid-cols-[25rem_1fr] h-screen">
        <div
        ...
        <div className="p-8 overflow-y-auto h-full">
          {!selectedVehicle && (
            <div className="flex justify-center items-center h-4/5 opacity-30">
              <img
          ...
          {selectedVehicle && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="grid-in-info flex flex-col justify-between">
                ...
                <p className="text-base mb-6">{selectedVehicle.description}</p>
                ...
                <div className="flex justify-around mb-4 gap-12">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm text-center">12 Month Warranty</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <i className="text-4xl mb-2">
                      <TbManualGearbox />
                    </i>
                    <span className="text-sm text-center">Manual Gearbox</span>
                  </div>
                </div>
